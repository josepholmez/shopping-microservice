package com.olmez.productservice.utility;
...
public class SourceUtils {
     ...
     */
    public static final String PRODUCT_SERVICE_SOURCE = "classpath:/application-product.yml";
    ...
    public static void setSpringConfigLocation() {
        System.setProperty(SPRING_CONFIG_LOCATION_KEY, PRODUCT_SERVICE_SOURCE);
    }
