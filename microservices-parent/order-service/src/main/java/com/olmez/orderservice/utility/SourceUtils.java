package com.olmez.orderservice.utility;
...
public class SourceUtils {
     ...
     */
    public static final String ORDER_SERVICE_SOURCE = "classpath:/application-order.yml";
    ...
    public static void setSpringConfigLocation() {
        System.setProperty(SPRING_CONFIG_LOCATION_KEY, ORDER_SERVICE_SOURCE);
    }
