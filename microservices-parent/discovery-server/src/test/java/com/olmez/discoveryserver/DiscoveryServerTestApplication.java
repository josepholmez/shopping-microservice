...
public class DiscoveryServerTestApplication {

	private Logger log = LoggerFactory.getLogger(getClass());

	public static void main(String[] args) {
		SpringApplication.run(DiscoveryServerTestApplication.class, args);
	}
	...
	CommandLineRunner init() {
		return args -> {
			log.info("Discovery Server TEST Application is running!");
		};
	}
}
