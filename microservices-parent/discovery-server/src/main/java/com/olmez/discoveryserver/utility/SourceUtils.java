package com.olmez.discoveryserver.utility;
...
public class SourceUtils {
     ...
     */
    public static final String DISCOVERY_SERVER_SOURCE = "classpath:/application-discovery.yml";
    ...
    public static void setSpringConfigLocation() {
        System.setProperty(SPRING_CONFIG_LOCATION_KEY, DISCOVERY_SERVER_SOURCE);
    }
