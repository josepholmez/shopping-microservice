package com.olmez.apigateway.utility;
...
public class SourceUtils {
     ...
     */
    public static final String API_GATEWAY_SOURCE = "classpath:/application-api-gateway.yml";
    ...
    public static void setSpringConfigLocation() {
        System.setProperty(SPRING_CONFIG_LOCATION_KEY, API_GATEWAY_SOURCE);
    }
